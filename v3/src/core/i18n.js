...
const DICT = {
  th: {
    appName:"Attendance Online v3", dashboard:"ภาพรวม", employees:"พนักงาน", attendance:"ลงเวลา", summary:"สรุปรายวัน", leave:"วันลา", calendar:"ปฏิทิน", payroll:"Payroll", profile:"โปรไฟล์", settings:"ตั้งค่า", logout:"ออก", notifications:"แจ้งเตือน", login:"เข้าสู่ระบบ", employeeCode:"รหัสพนักงาน", pin:"PIN",
    attendanceTools:"เครื่องมือเวลา", geofenceSettings:"ตำแหน่งบริษัท", requestOT:"ขอ OT", monthlyPayday:"วันจ่ายเงินพนักงานรายเดือน"
  },
  my: {
    appName:"Attendance Online v3", dashboard:"ခြုံငုံကြည့်ရန်", employees:"ဝန်ထမ်းများ", attendance:"အချိန်မှတ်တမ်း", summary:"နေ့စဉ် အကျဉ်းချုပ်", leave:"ခွင့်", calendar:"ပြက္ခဒိန်", payroll:"လစာ", profile:"ပရိုဖိုင်", settings:"ဆက်တင်", logout:"ထွက်မည်", notifications:"အသိပေးချက်", login:"ဝင်ရောက်ရန်", employeeCode:"ဝန်ထမ်းကုဒ်", pin:"PIN",
    attendanceTools:"အချိန်ကိရိယာများ", geofenceSettings:"ကုမ္ပဏီတည်နေရာ", requestOT:"OT တောင်းဆိုရန်", monthlyPayday:"လစဉ်ဝန်ထမ်း လစာပေးရက်"
  },
  en: {
    appName:"Attendance Online v3", dashboard:"Dashboard", employees:"Employees", attendance:"Attendance", summary:"Daily Summary", leave:"Leave", calendar:"Calendar", payroll:"Payroll", profile:"Profile", settings:"Settings", logout:"Logout", notifications:"Notifications", login:"Login", employeeCode:"Employee Code", pin:"PIN",
    attendanceTools:"Attendance Tools", geofenceSettings:"Company Location", requestOT:"Request OT", monthlyPayday:"Monthly payday"
  }
};
...
const STATIC_TRANSLATIONS = {
  en: {
    ...
    "ติดตั้ง Attendance เป็นแอป":"Install Attendance as an app", "เปิดได้จากหน้าจอมือถือ ใช้งานเร็วขึ้น และรองรับ Offline":"Open from your home screen, faster and supports offline", "ติดตั้ง":"Install", "ออฟไลน์: ข้อมูลใหม่จะบันทึกไม่ได้จนกว่าจะมีอินเทอร์เน็ต":"Offline: new data cannot be saved until internet is available", "มีเวอร์ชันใหม่พร้อมใช้งาน":"A new version is ready", "รีโหลด":"Reload", "เปิดแจ้งเตือนบนเครื่องนี้แล้ว":"Notifications enabled on this device", "มีแจ้งเตือนใหม่":"New notification", "วันนี้เป็น":"Today is "
  },
  my: {
    ...
    "ติดตั้ง Attendance เป็นแอป":"Attendance ကို App အဖြစ် ထည့်သွင်းရန်", "ติดตั้ง":"ထည့်သွင်း", "ออฟไลน์: ข้อมูลใหม่จะบันทึกไม่ได้จนกว่าจะมีอินเทอร์เน็ต":"Offline: အင်တာနက်ရှိမှ အချက်အလက်အသစ် သိမ်းနိုင်ပါမည်", "มีเวอร์ชันใหม่พร้อมใช้งาน":"ဗားရှင်းအသစ် ရရှိပါပြီ", "รีโหลด":"ပြန်ဖွင့်", "วันนี้เป็น":"ယနေ့သည် "
  }
};
